    ...
    <div class="<?php echo $this->enable_rtl ? 'right_col' : 'left_col'; ?> scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo site_url('dashboard/index'); ?>">
                ...
                <?php } else { ?>
                    <img class="logo" src="<?php echo IMG_URL; ?>/artech_logo.png" alt="">
                <?php } ?>
            </a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    ?>
                    <!-- <li><a  href="<?php // echo site_url('theme/index'); 
                                        ?>"><i class="fa fa-cubes"></i> <?php //echo $this->lang->line('theme'); 
                                                                                                                ?></a></li>  -->
                    <?php //} 
                    ?>
                    ...
                    ?>
                    <!-- <li><a  href="<?php // echo site_url('language/index'); 
                                        ?>"><i class="fa fa-language"></i> <?php // echo $this->lang->line('language'); 
                                                                                                                    ?></a></li> -->
                    <?php //} 
                    ?>
