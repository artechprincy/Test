        ...
        <div class="navbar nav_title" style="border: 0;">
            <a href="<?php echo site_url('dashboard/index'); ?>">
                ...
                <?php if ($this->session->userdata('role_id') != SUPER_ADMIN) { ?>
                    ...
                    ?>
                        <!-- <img class="logo" src="<?php echo UPLOAD_PATH . 'logo/artech_logo.png'; ?>" style="max-width: 100%" alt=""> -->
                        <img class="logo" src="<?php echo UPLOAD_PATH . 'logo/' . $this->school_setting->frontend_logo; ?>" style="max-width: 100%;max-height: 6em" alt="">
                    <?php } else { ?>
                        <img class="logo" src="<?php echo UPLOAD_PATH; ?>/logo/artech_logo.png" alt="" style="max-width: 100%; max-height 6em;">
                    <?php } ?>
                <?php } else { ?>
                    <img class="logo" src="<?php echo UPLOAD_PATH; ?>/logo/artech_logo.png" alt="" style="max-width: 100%; max-height 6em;">
                <?php } ?>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_administrator', $this->session->userdata('role_id'))) {
                        if (
                            ...
                            <li><a><i class="fa fa-user"></i> <?php echo $this->lang->line('administrator'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <?php if ($this->session->userdata('role_id') == ADMIN) { ?>
                                        <li><a href="<?php echo site_url('administrator/admission_no'); ?>"><?php echo $this->lang->line('admission_no'); ?></a></li>
                                        <li><a href="<?php echo site_url('administrator/roll_no'); ?>"><?php echo $this->lang->line('manage_roll_no'); ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                    <?php }
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_template', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'administrator', 'emailtemplate') || has_permission(VIEW, 'administrator', 'smstemplate')) { ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_front_office', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_human_resource', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'hrm', 'designation') || has_permission(VIEW, 'hrm', 'employee')) { ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_teacher', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_manage_leave', $this->session->userdata('role_id'))) {
                        if (
                            has_permission(VIEW, 'leave', 'leave') || has_permission(VIEW, 'leave', 'type') ||
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_academic', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_lesson_plan', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_class_routine', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'academic', 'routine')) { ?>
                            <li> <a href="<?php echo site_url('academic/routine/index'); ?>"> <i class="fa fa-clock-o"></i><?php echo $this->lang->line('class_routine'); ?></a></li>
                    <?php }
                    } ?>

                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_guardian', $this->session->userdata('role_id'))) {
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_manage_student', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_attendance', $this->session->userdata('role_id'))) { ?>
                            <?php if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_generate_card', $this->session->userdata('role_id'))) {
                        if (
                            ...
                            <li><a><i class="fa fa-barcode"></i> <?php echo $this->lang->line('generate_card'); ?><span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <?php if (has_permission(VIEW, 'card', 'schoolidsetting')) { ?>
                                        <li><a href="<?php echo site_url('card/schoolidsetting/index'); ?>">School <?php echo $this->lang->line('id_card_setting'); ?></a></li>
                                    <?php } ?>
                                    <?php if (has_permission(VIEW, 'card', 'schooladmitsetting')) { ?>
                                        <li><a href="<?php echo site_url('card/schooladmitsetting/index'); ?>">School <?php echo $this->lang->line('admit_card_setting'); ?></a></li>
                                    <?php } ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_online_exam', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_manage_exam', $this->session->userdata('role_id'))) {
                        if (
                            ...
                            <li><a><i class="fa fa-graduation-cap"></i> <?php echo $this->lang->line('manage_exam'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <?php if ($this->session->userdata('role_id') == ADMIN) { ?>
                                        <li><a href="<?php echo site_url('exam/room/index'); ?>">Room</a></li>
                                    <?php } ?>
                    ...
                    <?php if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_exam_mark', $this->session->userdata('role_id'))) { ?>
                            <?php if (
                    ...
                    <?php
                    if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_promotion', $this->session->userdata('role_id'))) {
                            if (has_permission(VIEW, 'academic', 'promotion')) { ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_certificate', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'certificate', 'certificate') || has_permission(VIEW, 'certificate', 'type')) { ?>
                    ...
                    <?php
                    if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_inventory', $this->session->userdata('role_id'))) {
                            if (
                    ...
                    <?php if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_asset_management', $this->session->userdata('role_id'))) { ?>
                            <?php if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_library', $this->session->userdata('role_id'))) {
                        if (
                            ...
                            <li><a><i class="fa fa-book"></i> <?php echo $this->lang->line('library'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <?php } ?>
                                    <?php if (has_permission(VIEW, 'library', 'apply')) { ?>
                                        <li><a href="<?php echo site_url('library/apply/index'); ?>"><?php echo $this->lang->line('apply_book'); ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                    <?php }
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_transport', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_hostel', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_complain', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'complain', 'complain') || has_permission(VIEW, 'complain', 'type')) { ?>
                            <li><a><i class="fa fa-commenting"></i> Communication <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <?php } ?>
                                    <?php
                                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_announcement', $this->session->userdata('role_id'))) {
                                        if (
                                    ...
                                    <?php
                                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_message', $this->session->userdata('role_id'))) {
                                        if (has_permission(VIEW, 'message', 'message')) { ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_scholarship', $this->session->userdata('role_id'))) {
                        if (
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_event', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'event', 'event')) { ?>
                    ...
                    <?php
                    // if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_payroll', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'payroll', 'grade') || has_permission(VIEW, 'payroll', 'payment')) { ?>
                    ...
                    <?php if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_accounting', $this->session->userdata('role_id'))) {
                            if (
                    ...
                    <?php
                    if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_report', $this->session->userdata('role_id'))) {
                            if (has_permission(VIEW, 'report', 'report')) { ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_media_gallery', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'gallery', 'gallery') || has_permission(VIEW, 'gallery', 'image')) { ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_frontend', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'frontend', 'frontend') || has_permission(VIEW, 'frontend', 'slider')) { ?>
                    ...
                    <?php
                    if (check_saas_status($this->session->userdata('school_id'), 'is_enable_miscellaneous', $this->session->userdata('role_id'))) {
                        if (has_permission(VIEW, 'miscellaneous', 'award') || has_permission(VIEW, 'miscellaneous', 'todo')) { ?>
                    ...
                    <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) { ?>
                        <li><a><i class="fa fa-thumbs-o-up"></i><?php echo $this->lang->line('subscription'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                            ...
                            <li><a href="<?php echo site_url('administrator/setting/index'); ?>"> <?php echo $this->lang->line('general_setting'); ?></a></li> -->
                                ...
                                <li><a href="<?php echo site_url('subscription/trials'); ?>">Trials</a></li>
                    ...
                    <?php
                    if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                        if (check_saas_status($this->session->userdata('school_id'), 'is_enable_setting', $this->session->userdata('role_id'))) { ?>
