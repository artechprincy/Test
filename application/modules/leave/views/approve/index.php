                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('leave/approve/update/'.$application->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <?php $this->load->view('layout/school_list_edit_form'); ?>  
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="leave_day" id="leave_day" value="<?php echo isset($application->leave_day) ? $application->leave_day : ''; ?>" readonly placeholder="<?php echo $this->lang->line('leave_day'); ?>" required="required" type="text" autocomplete="off">
 ...
 <script type="text/javascript">
   ...
   $(document).ready(function() {
    ...
    function leave_day() {
        ...
        const start = $('#leave_from').val();
        const end = $('#leave_to').val();
