                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_application_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'leave', 'type')) { ?>
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('leave/application/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_application" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                            ...
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <select class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_application_by_school_filter(this.value)">
                                    ...
                                    <?php foreach ($schools as $obj) { ?>
                                        <option value="<?php echo site_url('leave/application/index/' . $obj->id); ?>" <?php if (isset($filter_school_id) && $filter_school_id == $obj->id) {
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-12 col-xs-12" name="role_id" id="add_role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                            ...
                                            <?php foreach ($roles as $obj) {  ?>
                                                <?php if (in_array($obj->id, array(SUPER_ADMIN, GUARDIAN))) {
                                                    continue;
                                                } ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-12 col-xs-12" name="user_id" id="add_user_id" required="required" onchange="get_totol_leave()">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                        </select>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-12 col-xs-12" name="type_id" id="add_type_id" required="required" onchange="get_totol_leave()">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="add_leave_total">Total Approved leave this session</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" readonly id="add_leave_total" placeholder="Total leave this session" type="text" autocomplete="off">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="leave_date" id="add_leave_date" value="<?php echo isset($post['leave_date']) ?  $post['leave_date'] : date('d-m-Y'); ?>" placeholder="<?php echo $this->lang->line('application_date'); ?>" required="required" type="text" autocomplete="off" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="leave_from" id="add_leave_from" value="<?php echo isset($post['leave_from']) ?  $post['leave_from'] : date('d-m-Y'); ?>" placeholder="<?php echo $this->lang->line('leave_from'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="leave_to" id="add_leave_to" value="<?php echo isset($post['leave_to']) ?  $post['leave_to'] : date('d-m-Y'); ?>" placeholder="<?php echo $this->lang->line('leave_to'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('leave_to'); ?></div>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_day">Leave Day</label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="leave_day" id="add_leave_day" value="<?php echo isset($post['leave_day']) ?  $post['leave_day'] : ''; ?>" readonly placeholder="<?php echo $this->lang->line('leave_day'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('leave_day'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade in <?php if (isset($edit)) {
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="user_id"><?php echo $this->lang->line('applicant'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-12 col-xs-12" name="user_id" id="edit_user_id" required="required" onchange="get_totol_leave()">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                            <div class="help-block"><?php echo form_error('user_id'); ?></div>
                                        </div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="type_id"><?php echo $this->lang->line('leave_type'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-12 col-xs-12" name="type_id" id="edit_type_id" required="required" onchange="get_totol_leave()">
                                                <option itemid="" value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                            <div class="help-block"><?php echo form_error('type_id'); ?></div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="edit_leave_total">Total leave this session</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" readonly id="edit_leave_total" placeholder="Total leave this session" type="text" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="leave_day">Leave Day</label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="leave_day" id="edit_leave_day" value="<?php echo isset($post['leave_day']) ?  $post['leave_day'] : ''; ?>" placeholder="Leave Day" required="required" type="text" readonly autocomplete="off">
                                            <div class="help-block"><?php echo form_error('leave_day'); ?></div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    $('#add_leave_from').change(function() {
        leave_day();
    });
    $('#edit_leave_from').change(function() {
        leave_day();
    });

    $('#add_leave_to').change(function() {
        leave_day();
    });
    $('#edit_leave_to').change(function() {
        leave_day();
    });
    ...
    function leave_day() {
        ...
        const start = $('#' + form + '_leave_from').val();
        const end = $('#' + form + '_leave_to').val();
        // const days = Math.ceil(Math.abs(end - start) / (1000 * 60 * 60 * 24));
        // leave_days = days + 1;

        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ajax/get_leave_days_by_school'); ?>",
            data: {
                school_id: school_id,
                start: start,
                end: end
            ...
            success: function(response) {
                if (response) {
                    $('#' + form + '_leave_day').val(response);
                }
            }
        });
    }

    function get_totol_leave() {
        var school_id = $('.fn_school_id').val();
        if (!school_id) {
            toastr.error('<?php echo $this->lang->line("select_school"); ?>');
            return false;
        ...
        var role_id = $('#' + form + '_role_id').val();
        var class_id = ($('#' + form + '_class_id').val() != "") ? $('#' + form + '_class_id').val() : '0';
        var user_id = $('#' + form + '_user_id').val();
        var type_id = $('#' + form + '_type_id').val();
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ajax/get_leave_total_by_school'); ?>",
            data: {
                school_id: school_id,
                role_id: role_id,
                class_id: class_id,
            ...
            success: function(response) {
                ...
                if (response) {
                    $('#' + form + '_leave_total').val(response);
                }
            }
        });
    }
