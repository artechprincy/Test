                        ...
                        ?>
                            <?php foreach ($teachers as $obj) { ?>
                                ...
                                <tr class="checklisttr">
                                    ...
                                    <td><input type="radio" value="H" itemid="<?php echo $obj->id; ?>" name="teacher_<?php echo $obj->id; ?>" class="holiday fn_single_attendnce" <?php if ($attendance == 'H') {
                                                                                                                                                                                        echo 'checked="checked"';
                                                                                                                                                                                    } ?> /></td>
                                </tr>
                            <?php } ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#all_attendence').click(function() {
            $('tr.checklisttr > td > input:radio:checked').each(function() {
                var status = $(this).val();
                var teacher_id = $(this).attr('itemid');
                statusupdate(status, teacher_id);
            });
            toastr.success('<?php echo $this->lang->line('update_success'); ?>');
        });
    ...
    function statusupdate(status, teacher_id) {
        var school_id = $('#school_id').val();
        var start_date = $('#start_date').val();
        var to_date = $('#to_date').val();
