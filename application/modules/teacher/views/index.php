                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="pan_id"><?php echo $this->lang->line('pan_id'); ?> <span class="required">*</span></label>
                                            <input class="form-control col-md-7 col-xs-12 text-uppercase" name="pan_id" id="pan_id" value="<?php echo isset($post['pan_id']) ?  $post['pan_id'] : ''; ?>" placeholder="<?php echo $this->lang->line('pan_id'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('pan_id'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="department_id"><?php echo $this->lang->line('department'); ?> <span class="required">*</span></label>
                                            <select class="form-control col-md-7 col-xs-12 quick-field basic-multiple" name="department_id[]" id="add_department_id" required="required" multiple="multiple">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="pan_id"><?php echo $this->lang->line('pan_id'); ?> <span class="required">*</span></label>
                                                <input class="form-control col-md-7 col-xs-12" name="pan_id" id="pan_id" value="<?php echo isset($teacher->pan_id) ?  $teacher->pan_id : ''; ?>" placeholder="<?php echo $this->lang->line('pan_id'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('pan_id'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="department_id"><?php echo $this->lang->line('department'); ?> <span class="required">*</span></label>
                                                <select class="form-control col-md-7 col-xs-12 quick-field basic-multiple" name="department_id[]" id="edit_department_id" required="required" multiple="multiple">
                                                    <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                    <?php foreach ($departments as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($teacher->department_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <input type="hidden" name="prev_signature" id="prev_signature" value="<?php echo $teacher->signature; ?>" />
                                                <?php if ($teacher->signature) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/teacher-signature/<?php echo $teacher->signature; ?>" alt="" width="70" /><br /><br />
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
