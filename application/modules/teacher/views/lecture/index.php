                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_lecture_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'teacher', 'lecture')) { ?>

                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('teacher/lecture/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_lecture" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } ?>
                        <?php } ?>
                                ...
                                <select class="form-control col-md-7 col-xs-12" onchange="get_lecture_by_class(this.value);">
                                    ...
                                    <?php foreach ($class_list as $obj) { ?>
                                        <?php if ($this->session->userdata('role_id') == STUDENT) { ?>
                                            ...
                                            <option value="<?php echo site_url('teacher/lecture/index/' . $obj->id); ?>" <?php if (isset($class_id) && $class_id == $obj->id) {
                                                                                                                            echo 'selected="selected"';
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="instructions"><strong><?php echo $this->lang->line('instruction'); ?>: </strong> Please add Class, section and subject before create lecture.</div>
                                </div>
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="class_id" id="edit_class_id" required="required" onchange="get_subject_by_class(this.value, ''); get_section_by_class(this.value, '');">
                                                ...
                                                <?php if (isset($classes) && !empty($classes) && $this->session->userdata('role_id') != SUPER_ADMIN) { ?>
                                                    <?php foreach ($classes as $obj) { ?>
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($lecture->class_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                                                                                } ?>><?php echo $obj->name; ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="lecture_type" id="lecture_type" required="required" onchange="get_video_lecture_type(this.value, 'edit');">
                                                ...
                                                <?php $types = get_video_types(); ?>
                                                <?php foreach ($types as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>" <?php if ($lecture->lecture_type == $key) {
                                                                                            echo 'selected="selected"';
