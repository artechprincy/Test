                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('mess_cost'); ?></th>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_room">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('hostel/room/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mess_cost"><?php echo $this->lang->line('mess_cost'); ?></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="mess_cost"  id="mess_cost" value="<?php echo isset($post['mess_cost']) ?  $post['mess_cost'] : ''; ?>" placeholder="<?php echo $this->lang->line('mess_cost'); ?>" type="number" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('mess_cost'); ?></div>
                                    </div>
                                </div>
