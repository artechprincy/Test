                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_vehicle_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'transport', 'vehicle')) { ?>
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('transport/vehicle/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> </a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_vehicle" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> </a> </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                            ...
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <select class="form-control col-md-7 col-xs-12" onchange="get_vehicle_by_school(this.value);">
                                    ...
                                    <?php foreach ($schools as $obj) { ?>
                                        <option value="<?php echo site_url('transport/vehicle/index/' . $obj->id); ?>" <?php if (isset($filter_school_id) && $filter_school_id == $obj->id) {
                    ...
                    <div class="tab-content">
                                ...
                                <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo $this->lang->line('helper'); ?></th>
                                            <th><?php echo $this->lang->line('helper_contact'); ?></th>
                                        ...
                                        if (isset($vehicles) && !empty($vehicles)) { ?>
                                            <?php foreach ($vehicles as $obj) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $obj->helper; ?></td>
                                                    <td><?php echo $obj->helper_contact; ?></td>
                                                    <td>
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="model"><?php echo $this->lang->line('vehicle_model'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="model" id="model" value="<?php echo isset($post['model']) ?  $post['model'] : ''; ?>" placeholder="<?php echo $this->lang->line('vehicle_model'); ?>" type="text" required="required">
                                        <div class="help-block"><?php echo form_error('model'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="driver"><?php echo $this->lang->line('driver'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="driver" id="driver" value="<?php echo isset($post['driver']) ?  $post['driver'] : ''; ?>" placeholder="<?php echo $this->lang->line('driver'); ?>" type="text" required="required">
                                        <div class="help-block"><?php echo form_error('driver'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="license"><?php echo $this->lang->line('vehicle_license'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="license" id="license" value="<?php echo isset($post['license']) ?  $post['license'] : ''; ?>" placeholder="<?php echo $this->lang->line('vehicle_license'); ?>" type="text" required="required">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="contact" id="contact" value="<?php echo isset($post['contact']) ?  $post['contact'] : ''; ?>" placeholder="<?php echo $this->lang->line('vehicle_contact'); ?>" required="required" type="text" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');">
                                        <div class="help-block"><?php echo form_error('contact'); ?></div>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="helper"><?php echo $this->lang->line('helper'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="helper" id="helper" value="<?php echo isset($post['helper']) ?  $post['helper'] : ''; ?>" placeholder="<?php echo $this->lang->line('helper'); ?>" type="text" required="required">
                                        <div class="help-block"><?php echo form_error('helper'); ?></div>
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="helper_contact"><?php echo $this->lang->line('helper_contact'); ?> <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-7 col-xs-12" name="helper_contact" id="helper_contact" value="<?php echo isset($post['helper_contact']) ?  $post['helper_contact'] : ''; ?>" placeholder="<?php echo $this->lang->line('helper_contact'); ?>" type="text" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required="required">
                                        <div class="help-block"><?php echo form_error('helper_contact'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_vehicle">
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="model" id="model" value="<?php echo isset($vehicle->model) ?  $vehicle->model : ''; ?>" placeholder="<?php echo $this->lang->line('vehicle_model'); ?>" type="text" required="required">
                                            <div class="help-block"><?php echo form_error('model'); ?></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="driver" id="driver" value="<?php echo isset($vehicle->driver) ?  $vehicle->driver : ''; ?>" placeholder="<?php echo $this->lang->line('driver'); ?>" type="text" required="required">
                                            <div class="help-block"><?php echo form_error('driver'); ?></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="license" id="license" value="<?php echo isset($vehicle->license) ?  $vehicle->license : ''; ?>" placeholder="<?php echo $this->lang->line('vehicle_license'); ?>" type="text" required="required">
                                            <div class="help-block"><?php echo form_error('license'); ?></div>
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="helper" id="helper" value="<?php echo isset($vehicle->helper) ?  $vehicle->helper : ''; ?>" placeholder="<?php echo $this->lang->line('helper'); ?>" type="text" required="required">
                                            <div class="help-block"><?php echo form_error('helper'); ?></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input class="form-control col-md-7 col-xs-12" name="helper_contact" id="helper_contact" value="<?php echo isset($vehicle->helper_contact) ?  $vehicle->helper_contact : ''; ?>" placeholder="<?php echo $this->lang->line('helper_contact'); ?>" type="text" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required="required">
                                            <div class="help-block"><?php echo form_error('helper_contact'); ?></div>
                                        </div>
                                    </div>
