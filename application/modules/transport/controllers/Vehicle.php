...
class Vehicle extends MY_Controller {
    ...
    * ********************************************************** */
    private function _prepare_vehicle_validation() {
        ...
        $this->form_validation->set_rules('license', $this->lang->line('vehicle_license'), 'trim|required');
        $this->form_validation->set_rules('driver', $this->lang->line('driver'), 'trim|required');
        $this->form_validation->set_rules('driver', $this->lang->line('helper'), 'trim|required');
        $this->form_validation->set_rules('driver', $this->lang->line('helper_contact'), 'trim|required');
        $this->form_validation->set_rules('model', $this->lang->line('vehicle_model'), 'trim|required');
