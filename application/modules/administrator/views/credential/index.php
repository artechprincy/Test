        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="row">
                        ...
                        <div class="item form-group">
                            ...
                            <select class="form-control col-md-7 col-xs-12" name="role_id" id="role_id" onchange="get_user_by_role(this.value, '', '');">
                                ...
                                <?php foreach ($roles as $obj) { ?>
                                    <option value="<?php echo $obj->id; ?>" <?php if (isset($role_id) && $role_id == $obj->id) {
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12 display" style="display:<?php if (isset($class_id)) {
                                                                                        echo 'block';
                                                                                    } ?>">
                        <div class="item form-group">
