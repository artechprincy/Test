                                ...
                                <?php if (isset($roles) && !empty($roles)) { ?>
                                    <?php foreach ($roles as $obj) {
                                        ...
                                        if ($this->session->userdata('role_id') != SUPER_ADMIN) {
                                            if ($obj->id == '2' || $obj->id == '9' || $obj->id == '10' || $obj->id == '11' || $obj->id == '6' || $obj->id == '7' || $obj->id == '8') {
                                                continue;
                                            }
                                        }
                                    ?>
                                            ...
                                            <?php if (isset($modules) && !empty($modules)) { ?>
                                                ...
                                                foreach ($modules as $obj) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2" class="role-text" style="background: #ececec; font-weight: bold;"><?php echo $obj->module_name; ?> &raquo;</td>
                                                        <td><?php echo $this->lang->line('view'); ?> &nbsp; <input type="checkbox" data-id="<?= $obj->id ?>" class="role-check view" value="1" /> </td>
                                                        <td><?php echo $this->lang->line('add'); ?> &nbsp;<input type="checkbox" data-id="<?= $obj->id ?>" class="role-check add" value="1" /></td>
                                                        <td><?php echo $this->lang->line('edit'); ?> &nbsp;<input type="checkbox" data-id="<?= $obj->id ?>" class="role-check edit" value="1" /></td>
                                                        <td><?php echo $this->lang->line('delete'); ?> &nbsp; <input type="checkbox" data-id="<?= $obj->id ?>" class="role-check delete" value="1" /></td>
                                                    </tr>
                                                    ...
                                                    <?php if (isset($operations) && !empty($operations)) { ?>
                                                        ...
                                                        foreach ($operations as $op) { ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if ($op->is_view_vissible) { ?>
                                                                        <input type="checkbox" class="fn_view view<?= $op->module_id ?>" name="is_view[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_view) && $permission->is_view == 1) {
                                                            ...
                                                            <td>
                                                                <?php if ($op->is_add_vissible) { ?>
                                                                    <input type="checkbox" class="fn_add add<?= $op->module_id ?>" name="is_add[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_add) && $permission->is_add == 1) {
                                                                                                                                                                                        echo 'checked="checked"';
                                                                                                                                                                                    } ?> />
                                                            </td>
                                                        <?php } ?>
                                                        <td>
                                                            <?php if ($op->is_edit_vissible) { ?>
                                                                <input type="checkbox" class="fn_edit edit<?= $op->module_id ?>" name="is_edit[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_edit) && $permission->is_edit == 1) {
                                                                                                                                                                                        echo 'checked="checked"';
                                                                                                                                                                                    } ?> />
                                                        </td>
                                                    <?php } ?>
                                                    <td>
                                                        <?php if ($op->is_delete_vissible) { ?>
                                                            <input type="checkbox" class="fn_delete delete<?= $op->module_id ?>" name="is_delete[<?php echo $op->id; ?>]" value="1" <?php if (isset($permission->is_delete) && $permission->is_delete == 1) {
                                                                                                                                                                                        echo 'checked="checked"';
                                                                                                                                                                                    } ?> />
                                                    </td>
                                                <?php } ?>
