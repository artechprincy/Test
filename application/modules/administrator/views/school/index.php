                                                    ...
                                                    <td>
                                                        <select class="form-control col-md-7 col-xs-12 status-type" name="subscription_id" id="subscription_id" onchange="update_subscription_status('<?php echo $obj->id; ?>', this.value);">
                                                            ...
                                                            <?php foreach ($subscriptions as $sp) { ?>
                                                                <option value="<?php echo $sp->id; ?>" <?php echo $sp->id == $obj->subscription_id ?  'selected="selected"' : ''; ?>><?php echo $sp->school; ?> [<?php echo $sp->plan_name; ?>]</option>
                                                            <?php } ?>
                                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="phone" id="phone" value="<?php echo isset($post['phone']) ?  $post['phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" required="required" type="text" minlength="10" maxlength="12" oninput="this.value=this.value.replace(/[^0-9]/g,'');" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 currency" name="currency" id="currency" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach ($currencies as $currencie) { ?>
                                                    <option <?php if (isset($post) && $post['currency'] == $currencie['code']) {
                                                                echo 'selected="selected"';
                                                            } elseif ($currencie['code'] == 'INR') {
                                                                echo 'selected="selected"';
                                                            } ?> value="<?php echo $currencie['code']; ?>"><?php echo $currencie['code']; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12 currency_symbol" name="currency_symbol" id="currency_symbol" readonly value="<?php echo isset($post['currency_symbol']) ?  $post['currency_symbol'] : '₹'; ?>" placeholder="<?php echo $this->lang->line('currency_symbol'); ?> " required="required" type="text" autocomplete="off">
...
<script type="text/javascript">
    ...
    $(document).on('change', '.currency', function() {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('administrator/school/currency_symbol'); ?>",
            data: {
                currency: $(this).val()
            },
            async: false,
            success: function(response) {
                $('.currency_symbol').val(response);
            }
        });
    });
</script>