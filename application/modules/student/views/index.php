                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <?php
                            // if ($school->admission_no == "") {
                            //     error("please first Defain Addmission No.");
                            //     redirect('administrator/admission_no');
                            // }
                            ?>
                            <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="admission_no" id="add_admission_no" value="<?= $row->admission_no . $get_last_id ?>" readonly placeholder="<?php echo $this->lang->line('admission_no'); ?>" required="required" type="text" autocomplete="off">
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="phone" id="add_phone" value="<?php echo isset($post['phone']) ?  $post['phone'] : ''; ?>" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="<?php echo $this->lang->line('phone'); ?>" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <!-- <div class="btn btn-default btn-file">
                                                <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?> -->
                                                <input class="form-control col-md-7 col-xs-12" name="birth_certificate" id="add_birth_certificate" type="file">
                                            <!-- </div> -->
                                            <div class="help-block"><?php echo form_error('birth_certificate'); ?></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12 quick-field" name="section_id" onchange="get_roll()" id="add_section_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            </select>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <select class="form-control col-md-7 col-xs-12" name="group" onchange="get_roll()" id="add_group">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="roll_no" readonly id="add_roll_no" value="<?php echo isset($post['roll_no']) ?  $post['roll_no'] : ''; ?>" placeholder="<?php echo $this->lang->line('roll_no'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block" id="roll_error"><?php echo form_error('roll_no'); ?></div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="father_email"><?php echo $this->lang->line('father_email'); ?></label>
                                            <input class="form-control col-md-7 col-xs-12" name="father_email" id="add_father_email" value="<?php echo isset($post['father_email']) ?  $post['father_email'] : ''; ?>" placeholder="<?php echo $this->lang->line('father_email'); ?>" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            ...
                                            <input class="form-control col-md-7 col-xs-12" name="father_phone" id="add_father_phone" value="<?php echo isset($post['father_phone']) ?  $post['father_phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('father_phone'); ?>" type="text" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" autocomplete="off">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="mother_email"><?php echo $this->lang->line('mother_email'); ?></label>
                                            <input class="form-control col-md-7 col-xs-12" name="mother_email" id="add_mother_email" value="<?php echo isset($post['mother_email']) ?  $post['mother_email'] : ''; ?>" placeholder="<?php echo $this->lang->line('mother_email'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('mother_email'); ?></div>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="mother_phone"><?php echo $this->lang->line('mother_phone'); ?></label>
                                            <input class="form-control col-md-7 col-xs-12" name="mother_phone" id="add_mother_phone" value="<?php echo isset($post['mother_phone']) ?  $post['mother_phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('mother_phone'); ?>" type="text" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" autocomplete="off">
                                ...
                                <div class="<?php echo (isset($post['is_guardian'])) && $post['is_guardian'] != 'exist_guardian' ? '' : 'display'; ?> fn_except_exist">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="gud_phone"><?php echo $this->lang->line('phone'); ?> 
                                                <span class="required">*</span>
                                            </label>
                                                <input class="form-control col-md-7 col-xs-12" name="gud_phone" id="add_gud_phone" value="<?php echo isset($post['gud_phone']) ?  $post['gud_phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" type="text" required="required">
                                                <div class="help-block"><?php echo form_error('phone'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="gud_username">Guardian Login Id<?php // echo $this->lang->line('username'); ?> <span class="required">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <h5 class="column-title"><strong> Student login Detail<?php // echo $this->lang->line('other_information'); ?>:</strong></h5>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <input class="form-control col-md-7 col-xs-12" name="phone" id="add_phone" value="<?php echo isset($student->phone) ?  $student->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');"  type="text" autocomplete="off">
                                                <!-- <div class="help-block"><?php // echo form_error('phone'); ?></div> -->
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                ...
                                                <!-- <div class="btn btn-default btn-file">
                                                    <i class="fa fa-paperclip"></i> <?php echo $this->lang->line('upload'); ?> -->
                                                    <input class="form-control col-md-7 col-xs-12" name="birth_certificate" id="birth_certificate" type="file">
                                                <!-- </div> -->
                                                <div class="help-block"><?php echo form_error('birth_certificate'); ?></div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="father_email"><?php echo $this->lang->line('father_email'); ?></label>
                                                <input class="form-control col-md-7 col-xs-12" name="father_email" id="father_email" value="<?php echo isset($student->father_email) ?  $student->father_email : ''; ?>" placeholder="<?php echo $this->lang->line('father_email'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('father_email'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="father_phone"><?php echo $this->lang->line('father_phone'); ?></label>
                                                <input class="form-control col-md-7 col-xs-12" name="father_phone" id="father_phone" value="<?php echo isset($student->father_phone) ?  $student->father_phone : ''; ?>" placeholder="<?php echo $this->lang->line('father_phone'); ?>" type="text" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('father_phone'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="mother_email"><?php echo $this->lang->line('mother_email'); ?></label>
                                                <input class="form-control col-md-7 col-xs-12" name="mother_email" id="mother_email" value="<?php echo isset($student->mother_email) ?  $student->mother_email : ''; ?>" placeholder="<?php echo $this->lang->line('mother_email'); ?>" type="text" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('mother_email'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <label for="mother_phone"><?php echo $this->lang->line('mother_phone'); ?></label>
                                                <input class="form-control col-md-7 col-xs-12" name="mother_phone" id="mother_phone" value="<?php echo isset($student->mother_phone) ?  $student->mother_phone : ''; ?>" placeholder="<?php echo $this->lang->line('mother_phone'); ?>" type="text" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" autocomplete="off">
                                                <div class="help-block"><?php echo form_error('mother_phone'); ?></div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <div class="item form-group">
                                                <input type="hidden" name="prev_birth_certificate" id="prev_birth_certificate" value="<?php echo $student->birth_certificate; ?>" />
                                                <?php if ($student->birth_certificate) { ?>
                                                    <img src="<?php echo UPLOAD_PATH; ?>/student-birth-certificate/<?php echo $student->birth_certificate; ?>" alt="" width="70" /><br /><br />
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
...
<script type="text/javascript">
    ...
    function check_guardian_type(guardian_type) {
        ...
        if (guardian_type == 'father') {
            ...
            var f_email = $('#add_father_email').val();
            ...
            var m_email = $('#add_mother_email').val();
    ...
    function get_roll() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ajax/get_roll'); ?>",
            data: {
                class_id: class_id,
                section_id: section_id,
                group_id: group_id
            ...
            success: function(response) {
                if (response == 'error') {
                    $('#roll_error').html("<span class='text-danger'>Please class and Section add Roll No.</span>");
                    $('#add_roll_no').val("");
