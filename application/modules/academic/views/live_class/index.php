                                            ...
                                            <?php foreach ($live_classes as $obj) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($obj->class_type == 'zoom') {
                                                            $class_type = 'Zoom Meet';
                                                        } else if ($obj->class_type == 'jitsi') {
                                                            $class_type = 'Jitsi Meet';
                                                        } else if ($obj->class_type == 'google') {
                                                            $class_type = 'Google Meet';
                                                        }
                                                        ...
                                                        <?php if (has_permission(EDIT, 'academic', 'liveclass')) { ?>
                                                            <select class="form-control col-md-7 col-xs-12 gsms-nice-select_" name="class_status" id="class_status" onchange="update_class_status('<?php echo $obj->id; ?>', this.value);" style="height: 24px;margin-right: 8px;">
                                                                ...
                                                                <?php foreach ($class_status as $key => $value) { ?>
                                                                    <option value="<?php echo $key; ?>" <?php if ($obj->class_status == $key) {
                                                                                                            echo 'selected="selected"';
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-7 col-xs-12 data_subject" name="subject_id" id="add_subject_id" required="required" onchange="get_teacher_by_subject(this.value, '');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                        </select>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12 data_subject" name="class_type" id="add_class_type" required="required" onchange="set_live_class_type(this.value, 'edit');">
                                                ...
                                                <?php $types = get_live_class_types(); ?>
                                                <?php foreach ($types as $key => $value) { ?>
                                                    <option value="<?php echo $key; ?>" <?php if ($live_class->class_type == $key) {
                                                                                            echo 'selected="selected"';
                                                                                        } ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
...
<script type="text/javascript">
    ...
    function get_teacher_by_subject(subject_id) {
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('ajax/get_teacher_by_subject'); ?>",
            data: {
                subject_id: subject_id
            },
            async: false,
            success: function(response) {
                ...
                if (response) {
                    if (edit) {
                        $('#edit_teacher_id').val(response);
                    } else {
                        $('#add_teacher_id').val(response);
                    }
                }
            }
        });
