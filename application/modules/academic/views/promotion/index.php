                            ...
                            <?php  $position = get_position_in_class($school_id, $academic_year_id, $current_class_id, $obj->id); ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" value="<?php if(isset($obj)){ echo $obj->group;} ?>"  name="group[<?php echo $obj->id; ?>]"  class="form-control col-md-7 col-xs-12 small-field" required="required"  autocomplete="off"/>
                                    </td>
                                    <td>
