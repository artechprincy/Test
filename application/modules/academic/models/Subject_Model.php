...
class Subject_Model extends MY_Model {
    ...
    function __construct() {
     ...
     public function get_subject_list($class_id = null , $school_id = null){
        ...
        $this->db->select('S.*, SC.school_name, C.name AS class_name, T.name AS teacher, D.title as department_name');
        ...
        $this->db->join('departments AS D', 'D.id = S.department_id', 'left');
