                        ...
                        <?php if (has_permission(ADD, 'exam', 'exam')) { ?>
                            ...
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('exam/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                            ...
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <select class="form-control col-md-7 col-xs-12" onchange="get_exam_by_school(this.value);">
                                    ...
                                    <?php foreach ($schools as $obj) { ?>
                                        <option value="<?php echo site_url('exam/index/' . $obj->id); ?>" <?php if (isset($filter_school_id) && $filter_school_id == $obj->id) {
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-7 col-xs-12" name="academic_year_id" id="academic_year_id">
                                            <option selected disabled><?php echo $this->lang->line('academic_year'); ?></option>
                                            <?php foreach ($years as $year) { ?>
                                                <option value="<?php echo $year->id ?>" <?= isset($post['academic_year_id']) && $post['academic_year_id'] == $year->id ? "selected": "" ?>><?php echo $year->session_year ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-7 col-xs-12" name="academic_year_id" id="academic_year_id">
                                            <option selected disabled><?php echo $this->lang->line('academic_year'); ?></option>
                                            <?php foreach ($years as $year) { ?>
                                                <option value="<?php echo $year->id ?>" <?= isset($exam->academic_year_id) && $exam->academic_year_id == $year->id ? "selected": "" ?>><?php echo $year->session_year ?></option>
                                            <?php } ?>
                                        </select>
                                        <div class="help-block"><?php echo form_error('academic_year_id'); ?></div>
                                    </div>
