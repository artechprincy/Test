                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_room_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>

                        <?php if (isset($edit)) { ?>
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                                        } ?>"><a href="<?php echo site_url('exam/room/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                        <?php } else { ?>
                            <li class="<?php if (isset($add)) {
                                            echo 'active';
                                        } ?>"><a href="#tab_add_room" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                        ...
                        <li class="li-class-list">
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <select class="form-control col-md-7 col-xs-12" onchange="get_room_by_school(this.value);">
                                    <option value="<?php echo site_url('exam/room/index'); ?>">--<?php echo $this->lang->line('select_school'); ?>--</option>
                                    <?php foreach ($schools as $obj) { ?>
                                        <option value="<?php echo site_url('exam/room/index/' . $obj->id); ?>" <?php if (isset($filter_school_id) && $filter_school_id == $obj->id) {
                    ...
                    <div class="tab-content">
                                        ...
                                        if (isset($rooms) && !empty($rooms)) { ?>
                                            <?php foreach ($rooms as $obj) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('exam/room/edit/' . $obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                                        ...
                                                        <a href="<?php echo site_url('exam/room/delete/' . $obj->id); ?>" onclick="javascript: return confirm('<?php echo $this->lang->line('confirm_alert'); ?>');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line('delete'); ?> </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        <?php } ?>
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                <?php echo form_open(site_url('exam/room/add'), array('name' => 'add', 'id' => 'add', 'class' => 'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <a href="<?php echo site_url('exam/room/index'); ?>" class="btn btn-primary"><?php echo $this->lang->line('cancel'); ?></a>
                        ...
                        <?php if (isset($edit)) { ?>
                            <div class="tab-pane fade in active" id="tab_edit_room">
                                <div class="x_content">
                                    <?php echo form_open(site_url('exam/room/edit/' . $room->id), array('name' => 'edit', 'id' => 'edit', 'class' => 'form-horizontal form-label-left'), ''); ?>
...
<script type="text/javascript">
    function get_room_modal(room_id) {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('exam/room/get_single_room'); ?>",
            data: {
                room_id: room_id
            },
...
<script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('exam/room/get_hostel_by_school'); ?>",
            data: {
                school_id: school_id,
                hostel_id: hostel_id
            },
