    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
                            ...
                            <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <tbody>
                                    <tr>
                                        ...
                                        <th width="20%"><?php echo $this->lang->line('roll_no'); ?> :</th>
                                        <td width="30%"><?php echo $student->roll_no; ?></td>
                                    </tr>
                                    <tr>
                                        <th width="20%">Class & Section:</th>
                                        <td width="30%"><?php echo $student->class_name; ?> <?php echo $student->section; ?></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="30%"><?php echo date('d/m/Y', strtotime($student->dob)); ?></td>
                                        <th width="20%"><?php echo $this->lang->line('blood_group'); ?></th>
                                        <td width="30%"><?php echo $this->lang->line($student->blood_group); ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td width="30%"><?php echo $student->phone; ?></td>
                                    </tr>
                                    <tr>
            ...
            <div class="rowt">
                ...
                <div class="col-xs-4 text-center signature float-left">
