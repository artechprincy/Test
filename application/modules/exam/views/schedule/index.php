                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_schedule_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'exam', 'schedule')) { ?>

                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('exam/schedule/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_schedule" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if (isset($edit)) { ?>
                                ...
                                <select class="form-control col-md-7 col-xs-12" onchange="get_schedule_list_by_class(this.value);">
                                    ...
                                    <?php foreach ($class_list as $obj) { ?>
                                        <?php if ($this->session->userdata('role_id') == STUDENT) { ?>
                                            ...
                                            <option value="<?php echo site_url('exam/schedule/index/' . $obj->id); ?>" <?php if (isset($class_id) && $class_id == $obj->id) {
                                                                                                                            echo 'selected="selected"';
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select class="form-control col-md-7 col-xs-12" name="room_no" id="add_room_no" required="required" onchange="get_subject_by_class(this.value, '');">
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                            <?php if (isset($rooms) && !empty($rooms)) { ?>
                                                <?php foreach ($rooms as $obj) { ?>
                                                    <option value="<?php echo $obj->room_no; ?>" <?php echo isset($post['room_no']) && $post['room_no'] == $obj->room_no ?  'selected="selected"' : ''; ?>><?php echo $obj->room_no; ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="exam_id" id="edit_exam_id" required="required">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach ($exams as $obj) { ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php if ($obj->id == $schedule->exam_id) {
                                                                                                echo 'selected="selected"';
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="class_id" id="edit_class_id" required="required" onchange="get_subject_by_class(this.value, '');">
                                                ...
                                                <?php foreach ($classes as $obj) { ?>
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $obj->id; ?>" <?php if ($obj->id == $schedule->class_id) {
                                                                                                echo 'selected="selected"';
                                                                                            } ?>><?php echo $obj->name; ?></option>
                                                <?php } ?>
                                            </select>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="room_no" id="add_room_no" required="required" onchange="get_subject_by_class(this.value, '');">
                                                ...
                                                <?php if (isset($rooms) && !empty($rooms)) { ?>
                                                    <?php foreach ($rooms as $obj) { ?>
                                                        <option value="<?php echo $obj->room_no; ?>" <?php echo isset($schedule->room_no) && $schedule->room_no == $obj->room_no ?  'selected="selected"' : ''; ?>><?php echo $obj->room_no; ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                            </select>
                                            <div class="help-block"><?php echo form_error('room_no'); ?></div>
