...
class Exam extends MY_Controller {
    ...
    * ********************************************************** */
    public function index($school_id = null) {
        ...
        $this->data['years'] = $this->exam->get_year_list($school_id);
        $this->data['exams'] = $this->exam->get_exam_list($school_id);
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['years'] = $this->exam->get_year_list();
    ...
    * ********************************************************** */
    private function _prepare_exam_validation() {
        ...
        $this->form_validation->set_rules('academic_year_id', $this->lang->line('academic_year_id'), 'trim');
    }
