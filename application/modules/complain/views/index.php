                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul class="nav nav-tabs bordered">
                        <li class="<?php if (isset($list)) {
                                        echo 'active';
                                    } ?>"><a href="#tab_complain_list" role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('list'); ?></a> </li>
                        <?php if (has_permission(ADD, 'complain', 'complain')) { ?>
                            <?php if (isset($edit)) { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="<?php echo site_url('complain/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } else { ?>
                                <li class="<?php if (isset($add)) {
                                                echo 'active';
                                            } ?>"><a href="#tab_add_complain" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?></a> </li>
                            <?php } ?>
                            ...
                            <?php if ($this->session->userdata('role_id') == SUPER_ADMIN) {  ?>
                                <select class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_complain_by_school(this.value,'')">
                                    ...
                                    <?php foreach ($schools as $obj) { ?>
                                        <option value="<?php echo site_url('complain/index/' . $obj->id); ?>" <?php if (isset($filter_school_id) && $filter_school_id == $obj->id) {
                    ...
                    <div class="tab-content">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if (!empty($user)) {
                                                            echo $user->name;
                                                        ?>
                                                            <br />[<?php echo $this->lang->line('role') . ': ' . $obj->role_name ?> <?php if ($obj->role_id == STUDENT) {
                        ...
                        <div class="tab-pane fade in <?php if (isset($add)) {
                            ...
                            <div class="x_content">
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="action_note"><?php echo $this->lang->line('note'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea class="form-control col-md-7 col-xs-12" name="action_note" id="action_note" required="required" placeholder="<?php echo $this->lang->line('note'); ?>"></textarea>
                            ...
                            <div class="tab-pane fade in active" id="tab_edit_complain">
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="role_id" id="edit_role_id" required="required" onchange="get_user_by_role(this.value, '');">
                                                ...
                                                <?php if (isset($roles) &&  !empty($roles)) { ?>
                                                    <?php foreach ($roles as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($complain->role_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                    ...
                                    <div class="item form-group display">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-12 col-xs-12" name="class_id" id="edit_class_id" onchange="get_user('', this.value,'');">
                                                ...
                                                <?php if (isset($classes) &&  !empty($classes)) { ?>
                                                    <?php foreach ($classes as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($complain->class_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                                                                                } ?>><?php echo $obj->name; ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control col-md-7 col-xs-12" name="type_id" id="edit_type_id" required="required">
                                                ...
                                                <?php if (isset($complain_types) && !empty($complain_types)) { ?>
                                                    <?php foreach ($complain_types as $obj) { ?>
                                                        <option value="<?php echo $obj->id; ?>" <?php if ($complain->type_id == $obj->id) {
                                                                                                    echo 'selected="selected"';
                                                                                                } ?>><?php echo $obj->purpose; ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                            </select>
                                            <div class="help-block"><?php echo form_error('type_id'); ?></div>
                                    ...
                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="action_note"><?php echo $this->lang->line('note'); ?> <span class="required">*</span></label>
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <textarea class="form-control col-md-7 col-xs-12" name="action_note" id="action_note" required="required" placeholder="<?php echo $this->lang->line('note'); ?>"><?php echo isset($complain->action_note) ?  $complain->action_note : ''; ?></textarea>
                                            <div class="help-block"><?php echo form_error('action_note'); ?></div>
                                        </div>
                                    </div>
